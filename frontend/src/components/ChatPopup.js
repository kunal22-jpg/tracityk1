      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          {isLoading && (
            ...
            >
              <div className="bg-slate-800/80 text-slate-100 border border-slate-700/50 px-4 py-3 rounded-2xl">
        ...
        <div className="border-t border-purple-500/30 p-4">
          <div className="flex items-center space-x-3">
            <input
              ...
              className="flex-1 bg-slate-800/50 border border-slate-700/50 rounded-xl px-4 py-3 text-white placeholder-slate-400 focus:outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/50"
              disabled={isLoading}
            />
            <button
